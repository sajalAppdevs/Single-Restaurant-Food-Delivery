...
class Locals {
  ...
  String get appName {
    return _localizedValues[locale.languageCode]!['Zeymur']!;
  }
  ...
  String get featured {
    return _localizedValues[locale.languageCode]!['Featured']!;
  }

  String get onSale {
    return _localizedValues[locale.languageCode]!['OnSale']!;
  }
}
